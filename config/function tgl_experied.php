...
if ($tgl_hari_ini >= $tgl_experied) {
	echo "<SCRIPT language=Javascript>
		  alert('WEBSITE Anda telah berakhir, silahkan hubungi nomer 085703333785 <br><b>untuk info lebih lanjut</b>')
 		 </script> ";
	for ($aku = 0; $aku <= 5; $aku++) {
	...
	<script>
		$(document).ready(function() {
			alert('WEBSITE Anda akan segera berakhir, silahkan hubungi pemulungkode.com');
		});
	</script>
<?php
}
