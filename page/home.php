...
<head>
  ...
  <title>WEBSITE PEMESANAN MENU MAKANAN | RESTO PENJARA</title>
  ...
  <div class="wrapper">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="/">RESTO PENJARA <span class="sr-only">(current)</span></a></li>
              <!-- <li><a href="#">Link</a></li> -->
              <?php
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        <b>WEBSITE PEMESANAN MAKANAN</b>
      </div>
      <strong>Copyright &copy; 2022 <a href="#">RESTO PENJARA</a>
      </strong>
    </footer>
